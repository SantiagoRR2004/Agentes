...
public class HouseView extends GridWorldView {
  ...
  Thread refresh =
    ...
    public HouseView(HouseModel model) {
        ...
        setSize(Toolkit.getDefaultToolkit().getScreenSize().width*3/7, Toolkit.getDefaultToolkit().getScreenSize().height*3/7);
    ...
    public void drawAgent(Graphics g, int x, int y, Color c, int id) {
		...
		if (id < 1) { 
			if (!lRobot.equals(lOwner) && !lRobot.equals(hmodel.lFridge) && !lRobot.equals(hmodel.lCharger)) {
				c = Color.yellow;
